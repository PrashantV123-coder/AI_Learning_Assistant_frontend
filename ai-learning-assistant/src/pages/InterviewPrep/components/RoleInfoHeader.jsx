  ...
  return (
    <div className='bg-white relative'>
        <div className='container mx:auto px-10 md:px-0'>
            <div className='h-[200px] flex flex-cols justify-center relative z-10'>
                ...
                <div className='flex items-center gap-3 mt-4'>
                    <div className='text-10[px] font-semibold text-white bg-black px-3 py-1 rounded-full'>
            ...
            <div className='w-[40vw] md:w-[30vw] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0'>
